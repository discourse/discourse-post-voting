...
module Upvotes
  class CommentsController < ::ApplicationController
    ...
    before_action :ensure_upvotes_enabled, only: [:load_more_comments, :create]
    ...
    def create
      ...
      comment = Upvotes::CommentCreator.create(
        user: current_user,
        post_id: @post.id,
    ...
    def ensure_upvotes_enabled
      raise Discourse::InvalidAccess if !@post.is_upvotes_topic?
    end
  end
end
