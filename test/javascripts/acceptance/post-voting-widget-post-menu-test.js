// TODO (glimmer-post-menu): Remove this file after the widget post-menu code is removed from core
...
acceptance(
  "Discourse Post Voting - Widget Post Menu - anon user",
  function (needs) {
...
acceptance(
  "Discourse Post Voting - Widget Post Menu - logged in user",
  function (needs) {
    setupPostVoting(needs);
    needs.user();
