...
RSpec.describe Upvotes::CommentsController do
  ...
  let(:comment_3) { Fabricate(:upvotes_comment, post: answer) }
  ...
  describe '#load_comments' do
    it 'returns the right response when user is not allowed to view post' do
      ...
      get "/upvotes/comments.json", params: {
  ...
  describe '#create' do
    ...
    it 'returns the right response when user is not allowed to create post' do
      ...
      post "/upvotes/comments.json", params: {
        post_id: answer.id,
    ...
    it 'publishes a comment created MessageBus message when a new comment is created' do
      ...
      expect(payload[:comment][:upvotes_vote_count]).to eq(0)
  ...
  describe '#update' do
    it 'should return 403 for an anon user' do
      put "/upvotes/comments.json", params: {
  ...
  describe '#destroy' do
    it 'should return 403 for an anon user' do
      delete "/upvotes/comments.json", params: { comment_id: comment.id }
    ...
    it 'should return 404 when comment_id param given does not exist' do
      ...
      delete "/upvotes/comments.json", params: { comment_id: -99999 }
